...
{
    // Start is called using UnityEngine;

        public GameObject coinsPrefab;
        public GameObject multipleCoinsPrefab;
        ...
        private void Start()
        {
            powerUpPool = new GameObject[maxCoins];

            for (int i = 0; i < maxCoins; i++)
            {
                // Alternate between boosterPrefab and shieldPrefab in the pool
                GameObject powerUpPrefab = (i % 2 == 0) ? coinsPrefab : multipleCoinsPrefab;
        ...
        private void SpawnPowerUp()
        {
            ...
            currentPowerUpIndex = (currentPowerUpIndex + 1) % maxCoins;
        ...
        public void ResetCoinsPosition(GameObject powerUp)
        {
            Vector3 randomSpawnPoint = playerTransform.position + Random.insideUnitSphere * 100f;
            randomSpawnPoint.y = 0f;
